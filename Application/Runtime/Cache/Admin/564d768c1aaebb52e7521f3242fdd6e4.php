...
<!-- 配置文件 -->
<script type="text/javascript" src="/think/Public/ueditor/ueditor.config.js"></script>
<!-- 编辑器源码文件 -->
<script type="text/javascript" src="/think/Public/ueditor/ueditor.all.js"></script>
<!-- 实例化编辑器 -->
